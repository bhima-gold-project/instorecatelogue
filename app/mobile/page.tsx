...
function MobileAuthContent() {
  ...
  useEffect(() => {
    ...
    if (!rawToken) {
      ...
      setDeniedMessage("No authentication token provided. Please access the catalogue through your authorized mobile application.");
      return;
    }
...
export default function MobileQueryTokenPage() {
  return (
